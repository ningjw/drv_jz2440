...
#define ALSA_CONFIG_DIR "/usr/local/alsa/share/alsa"
...
#define ALSA_PKGCONF_DIR "/usr/local/alsa/lib/pkgconfig"

/* directory containing ALSA add-on modules */
#define ALSA_PLUGIN_DIR "/usr/local/alsa/lib/alsa-lib"
